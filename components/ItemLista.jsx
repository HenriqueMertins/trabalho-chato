...
export default function ItemLista(props) {
  ...
  function confirmaExclusao(id, titulo) {
    // if (confirm(`Confirma Exclusão do Hoteles "${titulo}"?`)) {
    //   props.exclui(id)
    // }
    Swal.fire({
      title: `Confirma Exclusão do Hotel "${titulo}"?`,
  ...
  return (
    <tr>
      ...
      <td className={props.filme.destaque ? "fw-bold" : ""}>{props.filme.diaria}</td>
      <td className={props.filme.destaque ? "fw-bold" : ""}>{props.filme.pessoa}</td>
      <td className={props.filme.destaque ? "fw-bold" : ""}>{props.filme.dataEntrada}</td>
      <td className={props.filme.destaque ? "fw-bold" : ""}>{props.filme.data}</td>
